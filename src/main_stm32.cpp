#include "PAL.h" // We must include this before checking the PLATFORM
#if PLATFORM == STM32 // These functions and includes should only be used for the STM32.
