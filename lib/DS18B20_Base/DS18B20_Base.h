...
// Modifed to use PAL functions from: https://github.com/matmunk/DS18B20/blob/master/src/DS18B20.h and https://github.com/matmunk/DS18B20/blob/master/src/DS18B20.cpp
class DS18B20_Base {
    public:
