...
extern DSTATUS USER_SPI_initialize (BYTE pdrv) __FIRMWARE;
extern DSTATUS USER_SPI_status (BYTE pdrv) __FIRMWARE;
extern DRESULT USER_SPI_read (BYTE pdrv, BYTE *buff, DWORD sector, UINT count) __FIRMWARE;
#if _USE_WRITE == 1
  extern DRESULT USER_SPI_write (BYTE pdrv, const BYTE *buff, DWORD sector, UINT count) __FIRMWARE;
#endif /* _USE_WRITE == 1 */
#if _USE_IOCTL == 1
  extern DRESULT USER_SPI_ioctl (BYTE pdrv, BYTE cmd, void *buff) __FIRMWARE;
#endif /* _USE_IOCTL == 1 */
#endif
