...
/* Private define ------------------------------------------------------------*/
/* Private variables ---------------------------------------------------------*/
Disk_drvTypeDef __FIRMWARE_BSS disk = {{0},{0},{0},0};
...
/**
  ...
  */
uint8_t __FIRMWARE FATFS_LinkDriverEx(Diskio_drvTypeDef *drv, char *path, uint8_t lun)
{
  uint8_t ret = 1;
  uint8_t DiskNum = 0;
...
/**
  ...
  * @retval Returns 0 in case of success, otherwise 1.
  */
uint8_t __FIRMWARE FATFS_LinkDriver(Diskio_drvTypeDef *drv, char *path)
{
...
/**
  ...
  * @retval Returns 0 in case of success, otherwise 1.
  */
uint8_t __FIRMWARE FATFS_UnLinkDriverEx(char *path, uint8_t lun)
{ 
  uint8_t DiskNum = 0;
  uint8_t ret = 1;
...
/**
  ...
  * @retval Returns 0 in case of success, otherwise 1.
  */
uint8_t __FIRMWARE FATFS_UnLinkDriver(char *path)
{ 
...
/**
  ...
  */
uint8_t __FIRMWARE FATFS_GetAttachedDriversNbr(void)
{
  return disk.nbr;
}
